 ...
 *    - Comprehensive list covering all countries
...
export const countryList: Country[] = [
  ...
  { code: 'MA', name: 'Morocco and Western Sahara' },
  ...
  { code: 'QA', name: 'Qatar' },
  { code: 'RE', name: 'Réunion and Mayotte' },
  { code: 'RO', name: 'Romania' },
  { code: 'RU', name: 'Russian Federation' },
  { code: 'RW', name: 'Rwanda' },
  { code: 'SH', name: 'Saint Helena and also Tristan Da Cunha' },
