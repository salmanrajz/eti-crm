...
export async function sendChatMessageWhatsAppNotification(
  ...
  try {
    // Use the provided lead directly - caller is responsible for ensuring it's up-to-date
    // This removes retry delays that were causing performance issues
    // For new leads, caller should handle leadNumber generation retries if needed
