/**
 * ===============================================================================
 * NOTICE BOARD COMPONENT - DELIVERY SCHEDULE AND NOTICE MANAGEMENT
 * ===============================================================================
 * 
 * This component provides a notice board interface for displaying and managing
 * delivery schedules, area visit information, and important announcements.
 * It supports role-based editing capabilities and real-time updates.
 * 
 * FEATURES:
 * 
 * 1. NOTICE DISPLAY AND MANAGEMENT
 *    - Delivery schedule display with area-specific information
 *    - Markdown-style text formatting support
 *    - Tabular data display for area visit schedules
 * 
 * 2. ROLE-BASED EDITING
 *    - Coordinator role editing capabilities
 *    - Real-time notice updates and synchronization
 *    - Permission-based content modification
 * 
 * 3. CONTENT FORMATTING
 *    - Simple markdown parsing for bold and italic text
 *    - Structured table display for schedule information
 *    - Responsive design for various screen sizes
 * 
 * 4. FIREBASE INTEGRATION
 *    - Real-time notice synchronization via Firestore
 *    - Persistent notice storage and retrieval
 *    - Default notice fallback and initialization
 * 
 * USAGE:
 * This component is used in dashboard layouts to display important
 * delivery schedules and area visit information to all users.
 * ===============================================================================
 */
