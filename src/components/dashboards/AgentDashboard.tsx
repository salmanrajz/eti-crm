...
// ✅ ENHANCED: 1-hour cache duration with localStorage persistence
const CACHE_DURATION = 60 * 60 * 1000; // 1 hour
const LEADS_LIMIT = 6; // Only load 6 most recent leads

// ✅ ENHANCED: Active listeners tracker to prevent duplicate listeners
...
export function AgentDashboard({ user }: AgentDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-6 sm:py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
            ...
            <div className="flex flex-row sm:flex-row items-stretch sm:items-center gap-3 sm:gap-6 w-full sm:w-auto">
              ...
              >
                <div className="bg-gradient-to-br from-indigo-500/10 to-purple-500/10 backdrop-blur-sm border border-indigo-100/50 rounded-2xl p-3 sm:p-4">
              ...
              >
                <button
                  ...
                  className="w-full inline-flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 backdrop-blur-sm border border-indigo-100/50 rounded-2xl shadow-lg shadow-indigo-500/10 hover:shadow-xl hover:shadow-indigo-500/20 transition-all duration-300 group"
                >
                  <div className="flex items-center">
                    <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-2 rounded-xl mr-3 group-hover:scale-110 transition-transform duration-300">
                      <Target className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                    </div>
                    <div className="text-left">
                      <span className="block text-xs sm:text-sm font-semibold text-gray-900">My Performance</span>
                      <span className="hidden sm:block text-[10px] sm:text-xs text-gray-600">View detailed metrics</span>
                    </div>
                    <div className="ml-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
              ...
              >
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="text-left">
                      <span className="block text-xs sm:text-sm font-semibold text-gray-900">Submit Lead</span>
                      <span className="hidden sm:block text-[10px] sm:text-xs text-gray-600">Create a new lead</span>
                    </div>
                    <div className="ml-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
                      <ArrowRight className="w-4 h-4 text-indigo-600" />
                    </div>
        ...
        {/* MAR Strip Card */}
        <div className="mb-6">
          <div className="flex flex-col sm:flex-row items-center justify-between bg-gradient-to-r from-cyan-100 to-blue-100 border border-cyan-200 rounded-2xl px-6 py-4 shadow-md">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <Target className="h-6 w-6 text-cyan-600" />
                <span className="text-lg font-bold text-cyan-700">MAR:</span>
                <span className="text-lg font-bold text-cyan-900">{metrics.mar ?? 0}</span>
              </div>
              <div className="flex items-center gap-2 ml-6">
                <Zap className="h-6 w-6 text-purple-600" />
                <span className="text-lg font-bold text-purple-700">Achieved:</span>
                <span className="text-lg font-bold text-purple-900">{metrics.activated}</span>
              </div>
            </div>
            <div className="mt-3 sm:mt-0 sm:ml-8 flex-1">
              {metrics.activated < metrics.mar ? (
                <motion.div 
                  ...
                  className="hidden sm:flex items-start gap-3 text-sm bg-gradient-to-r from-red-50 to-orange-50 border border-red-200 rounded-xl px-4 py-3 shadow-lg relative overflow-hidden"
                >
                  ...
                  <div className="flex-1 relative z-10">
                    ...
                    >
                      You are yet to meet your Minimum Target Required (MAR) for this month.
                    </motion.div>
                    <motion.div 
                ...
                <motion.div 
                  ...
                  transition={{ duration: 0.5, ease: "easeOut" }}
                  whileHover={{ scale: 1.02, y: -2 }}
                  className="hidden sm:flex items-start gap-3 text-sm bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl px-4 py-3 shadow-lg"
                >
                  ...
                  <div className="flex-1">
                    ...
                    >
                      You have achieved your Minimum Target Required (MAR) for this month.
                    </motion.div>
                  </div>
                </motion.div>
              )}
        ...
        >
          ...
          {stats.map((stat, index) => (
            ...
            >
              <Link
                to={stat.href}
                className="block relative overflow-hidden rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.16)] transition-all duration-300 transform hover:-translate-y-1 cursor-pointer group"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/40 to-white/20 backdrop-blur-xl border border-white/20 rounded-2xl" />
        ...
        {leads.length > 0 && (
          ...
          >
            <div className="relative overflow-hidden rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/20">
              {/* Glassmorphism Background */}
              <div className="absolute inset-0 bg-gradient-to-br from-white/40 to-white/20 backdrop-blur-xl" />
              
              {/* Enhanced Header with Modern Design */}
              <div className="relative px-6 sm:px-8 py-8 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 overflow-hidden">
                {/* Background Pattern */}
                ...
                <div className="relative flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-4">
                    <Link
                      to="/dashboard/leads"
                      className="group inline-flex items-center px-6 py-3 bg-white/15 hover:bg-white/25 text-white rounded-xl transition-all duration-300 backdrop-blur-sm border border-white/20 hover:border-white/30 hover:scale-105 shadow-lg hover:shadow-xl"
                    >
