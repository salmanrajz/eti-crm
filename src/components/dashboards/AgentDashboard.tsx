...
export function AgentDashboard({ user }: AgentDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 pt-4 sm:pt-6 pb-6 sm:pb-12 relative overflow-hidden">
      ...
      <div className="max-w-full mx-auto relative z-10 px-2 sm:px-4">
        ...
        >
          ...
          <div className="sm:hidden space-y-3">
            ...
            <div className="flex items-center justify-between w-full gap-2">
              ...
              <div className="flex items-center flex-shrink-0">
                <div className="text-xs font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 whitespace-nowrap">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="text-left">
                      <span className="block text-xs font-semibold text-gray-900 whitespace-nowrap">Submit Lead</span>
                    </div>
                  </div>
                </Link>
              </motion.div>
          ...
          {/* Tablet / desktop: welcome + Submit Lead on first strip, other cards on the next */}
          <div className="hidden sm:block">
            <div
              className="flex items-center gap-3 rounded-3xl px-3 py-2.5 sm:px-4 sm:py-3 border"
              style={{
                background: 'linear-gradient(135deg, #F4F0FF 0%, #E8DCFF 48%, #DCCFF7 100%)',
                borderColor: '#CBB5F5',
                boxShadow: '0 8px 24px rgba(92, 64, 156, 0.08)',
              }}
            >
              <div className="min-w-0 flex-1">
                <h1 className="text-base sm:text-lg xl:text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 leading-tight">
                  Welcome back, <span className="bg-gradient-to-r from-orange-500 to-pink-500 bg-clip-text text-transparent">{user?.name}</span>!
                </h1>
              ...
              >
                <Link
                  to="/dashboard/leads/create"
                  className="inline-flex items-center px-3 py-2 bg-white/50 backdrop-blur-sm border border-indigo-100/60 rounded-xl shadow-md shadow-indigo-500/10 hover:shadow-lg hover:shadow-indigo-500/20 transition-all duration-300 group"
                >
                  <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-1.5 rounded-lg mr-2 group-hover:scale-110 transition-transform duration-300 shrink-0">
                    <PlusCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white" />
                  </div>
                  <div className="text-left">
                    <span className="block text-xs font-semibold text-gray-900 whitespace-nowrap">Submit Lead</span>
                    <span className="block text-[10px] text-gray-600 whitespace-nowrap">Create a new lead</span>
                  </div>
                </Link>
              </motion.div>
            </div>

            <div className="mt-5 sm:mt-6 grid grid-cols-3 items-center">
            <motion.div
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            ...
            >
              <button
                ...
                className="inline-flex items-center px-4 py-2.5 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 backdrop-blur-sm border border-emerald-100/50 rounded-2xl shadow-md shadow-emerald-500/10 hover:shadow-lg hover:shadow-emerald-500/20 transition-all duration-300 group text-left"
              >
                <div className="bg-gradient-to-br from-emerald-500 to-teal-600 p-2 rounded-lg mr-2.5 group-hover:scale-110 transition-transform duration-300 shrink-0">
                  <Target className="w-4 h-4 text-white" />
                </div>
                <div className="min-w-0">
                  <div className="text-sm font-semibold text-gray-900 whitespace-nowrap">My Performance</div>
                  <div className="text-[11px] text-gray-600 whitespace-nowrap">View detailed metrics</div>
                </div>
              </button>
            </motion.div>
            ...
            >
              <div className="inline-flex items-center rounded-2xl border border-emerald-100/50 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 backdrop-blur-sm px-4 py-2.5 shadow-md shadow-emerald-500/10">
                <div className="p-2 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg shadow-sm shadow-emerald-500/20 shrink-0 mr-2.5">
